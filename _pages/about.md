...
title: About
permalink: /
subtitle: "Open to AI, Data Engineering, and ML Engineering Roles"
...
**What I build:**
- **Scalable data pipelines** — distributed batch and streaming systems processing billions of events (Spark, Kafka, Airflow, dbt)
- **End-to-end ML systems** — from feature engineering and experimentation to model deployment and drift monitoring (MLflow, FastAPI, Docker, AWS)
- **Cloud-native data platforms** — warehouses, lakehouses, and real-time analytics infrastructure on AWS and GCP
